...
// Create member functions SetData() and DisplayData().Create two objects of class Employe.
...
{
    Employee EMp1,EMp2 ;
    cout<<"Setdata the Data of Employee 1 "<<endl;
    EMp1.setdata();
    cout<<"Display the Data of Employee 1 "<<endl;
    EMp1.DisplayData();
    cout<<"Setdata the Data of Employee 2 "<<endl;
    EMp2.setdata();
    cout<<"Display the Data of Employee 2 "<<endl;
    EMp2.DisplayData();
    return 0;
}
...
public:
    ...
    admin()
    {
        ...
        if (strcmp(s, str) == 0)
        {
            cout << "welcome Sarthak" << endl;
            display();
        }
        else
            cout << "Please contact sarthak to become an admin " << endl;
    }
};
// A, O+, B+, AB+, A-, O-, B-, AB-
...
int main()
{
    ...
    while (c != 4)
    {
        cout<<"Enter according to suitability :-"
